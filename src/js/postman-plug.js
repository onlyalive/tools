...
var paramsTr = `<tr class='last'>
                    <td><input type='text' class='form-control' data-stage='key'></td>
                    <td><input type='text' class='form-control' data-stage='value'></td>
                    <td class='w20'><i class='iconfont cursor color-adorn'>&#xe69d;</i></td>
                </tr>`;

var moduleDiv = `<div class='panel panel-info no-radius b0 mt0 left-menu-border-top'>
      <div class='panel-heading no-radius rel' data-parent='#modules'>
          <div class='cursor' data-toggle='collapse' data-parent='#modules' href='#panel_ca_moduleId' crap-data='ca_moduleId'>
              <i class='iconfont module-title-ico f16'>&#xe624;</i>&nbsp;&nbsp;  ca_moduleName
		        <span class='more'>
			        <i class='iconfont fr h lh40'>&#xe75f;</i>
			        <span class='t0 h'><i class='iconfont interface-menu rename-module mt0 lh40 fr'crap-data='ca_moduleId'>&#xe69e;</i></span>
	                <span class='t0 h'><i class='iconfont interface-menu delete-module mt0 lh40 fr' crap-data='ca_moduleId'>&#xe69d;</i></span>
			        <span class='t0 h'><i class='iconfont interface-menu down-module  mt0 lh40 fr' crap-data='ca_moduleId'>&#xe65e;</i></span>
			        <span class='t0 h'><i class='iconfont interface-menu up-module  mt0 lh40 fr' crap-data='ca_moduleId'>&#xe8e9;</i></span>
		        </span>
          </div>
      </div>
      <div id='panel_ca_moduleId' class='panel-collapse BGEEE collapse in'>
...
var interfaceDiv = `<div crap-data=\"ca_interfaceInfo\" class='interface pl20 pr20 rel' title='ca_name'>
		<i class='iconfont ca_method'>ca_methodIcon</i>&nbsp;&nbsp;ca_name
		<span class='more'>
			<i class='iconfont fr'>&#xe75f;</i>
			<span class='t0 h'><i class='iconfont interface-menu delete-interface' crap-data='ca_moduleId|ca_id'>&#xe69d;</i></span>
			<span class='t0 h'><i class='iconfont interface-menu down-interface' crap-data='ca_moduleId|ca_id'>&#xe65e;</i></span>
			<span class='t0 h'><i class='iconfont interface-menu up-interface' crap-data='ca_moduleId|ca_id'>&#xe8e9;</i></span>
		</span>
	</div>`;
...
function callAjax() {
                    ...
                    chrome.cookies.getAll({ domain: rootDomainStr }, function (cookies) {
                        ...
                        for (i = 0; i < cookies.length; i++) {
                            if (("." + a.host).endWith(cookies[i].domain)) {
                                var cookieStr = `<tr>
                                    <td class='w-p-10 break-word'>${cookies[i].name}</td>
                                    <td class='w-p-30 break-word'>${cookies[i].value}</td>
                                    <td class='w-p-20 break-word'>${cookies[i].path}</td>
                                    <td class='w-p-20 break-word'>${cookies[i].domain}</td>
                                    <td class='w-p-20 break-word'>${cookies[i].expirationDate}</td>
                                </tr>`;
    ...
    try {
        ...
        var h = {
            "paramType": $("input[name='param-type']:checked").val(), "name": $("#interface-name").val(), "method": method, "url": url,
